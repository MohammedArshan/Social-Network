  ...
  <body>
	  ...
	  <br>
        ...
        <div id="timeline">
				...
				echo "<h3 style='margin-bottom: 10px;'><a href='user_profile.php?profile_id=$row1[0]' style='text-decoration: none; color: black;'>$row1[1]</a></h3>";
				echo "<p>$row[3]</p>";
				echo "<br>";
				echo "<p>$row[2]</p>";
				echo "</div>";	
			...
			<textarea name="comment_text" placeholder="Write Comment" rows="2" cols="81"></textarea>
			<br>
			<input type="submit" value="Comment" name="comment" style="height: 35px; margin-bottom: 10px;"/> 
			</form>
		<?php 	insertComment();	?>
	</div>
	<br>
