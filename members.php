	  ...
	  <br>
		...
		<div id="timeline">
			...
			for ($j = 0 ; $j < $rows ; ++$j)
			{
				...
				echo "<div id='members'>";
				echo "<img src='images/$row[7]' width='50'  height='50' style='float: left; margin-right: 20px; border-radius: 5px;'>";
				echo "<h3 style='margin-bottom: 10px;'><a href='user_profile.php?profile_id=$row[0]' style='text-decoration: none; color: black;'>$row[1]</a></h1>";
