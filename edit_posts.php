...
<html lang="en" dir="ltr">
  ...
  <body>
	  ...
	  <br>
		...
		echo "<div id='posts11'>";
		echo "<img src='images/$user_image' width='50'  height='50' style='float: left; margin-right: 20px;'>";
		echo "<h3 style='margin-bottom: 10px;'>$user_name</h1>";
		echo "<p>$row[3]</p>";
		echo "<br>";
		echo "<p>$row[2]</p>";
		echo "</div>";
		...
		<form id="" action="" method="post">
			<textarea name="newpost" placeholder="Write your new post..." rows="4" cols="80"></textarea>
				<br>
				<input type="submit" value="Update Post" name="update" style="height: 35px;"/> 
			</form>
			<?php editPost(); ?>
		</div>
		<br>
